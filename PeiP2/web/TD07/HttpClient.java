...
public class HttpClient {
	...
	/**
	 * Add a line to the HTTP request body.
	 * This method will add the CRLF characters at the end of the line.
	 *
	 * @param bodyLine. The line to add to the HTTP body. "bodyLine" must not
	 *                  contains the CRLF characters.
	 **/
	public void addBodyLine(String bodyLine) {
		this.httpBody += bodyLine + "\r\n";
	}
	...
	public String[] sendRequest() {
		...
		if (!httpBody.isEmpty()) {
			try {
				...
				String contenu = "Content-Length: " + lenBytes;
				addHeaderLine(contenu);
