...
public class ChessGameInterface {
	...
	public static void jsonArrayParser(JSONArray ja) {
		for (int i = 0; i < ja.length(); i++) {
			Object val = ja.get(i);
			if (val instanceof String)
				System.out.println("La valeur associée à la clé " + i + " est le String: " + val);
		}
	}
	...
	public static void jsonParser(JSONObject jo) {
		for (String key : jo.keySet()) {
			...
			if (val instanceof String)
				System.out.println("La valeur associée à la clé " + key + " est le String: " + val);
			if (val instanceof JSONArray) {
				jsonArrayParser((JSONArray) val);
			}
		}
	}
	...
	public static void main(String[] args) {
		...
		String json = "{\"cle1\":\"valeur1\"}";
		String jsonkey = "cle1";

		System.out.println("La valeur associée à la clé " + jsonkey + " est : " +
				ChessGameInterface.getValueFromKeyJSON(json, jsonkey));
		...
		String json3 = """
						{"id":"123456","var1":"val1"}
				""";
		ChessGameInterface.jsonParser(new JSONObject(json3));

		// Question 4
		System.out.println("");
		String json4 = """
					{"id":"123456","tab1":["item1", "item2"]}
				""";
		ChessGameInterface.jsonParser(new JSONObject(json4));
	}
}
