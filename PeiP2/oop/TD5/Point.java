...
public class Point {
    ...
    public boolean egal(Point p) {
        return this.ordonnee() == p.ordonnee() && this.abscisse() == p.abscisse();
    }
    ...
    public double distance(Point p) {
        var x = Math.pow(p.abscisse() - this.abscisse(), 2);
        var y = Math.pow(p.ordonnee() - this.ordonnee(), 2);
    ...
    public String toString() {
        return String.format("[%f ; %f]", this.abscisse(), this.ordonnee());
    }
